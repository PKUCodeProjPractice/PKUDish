 ...
 * 如需修改请修改如下关联内容
 * enum Canteen
 * const std::string CANTEEN_NAME
 * std::map<std::string, Canteen> NAME_CANTEEN
 *
...
const std::string CANTEEN_NAME[CANTEEN_UNDEF] = {
    [CANTEEN_XUE_YI]    = "学一",
    [CANTEEN_XUE_WU]    = "学五",
...
Canteen getCanteenFromName(const std::string & name);
std::string getCanteenName(const Canteen);
